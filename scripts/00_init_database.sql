...
=============================================================
Summary:
    This script sets up a new database called 'DataWarehouseAnalytics'. 
    If the database already exists, it will be dropped and recreated. 
    A schema named 'gold' is also created.
	
NOTE:
    Running this will permanently delete the existing 'DataWarehouseAnalytics' database 
    and all its data. Ensure backups are in place before proceeding.
*/
